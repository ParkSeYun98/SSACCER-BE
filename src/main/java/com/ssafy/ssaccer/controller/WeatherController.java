...
public class WeatherController {
    ...
    public ResponseEntity<ModelAndView> longWeatherTemperatureData(@RequestParam String regId, @RequestParam int tmFc) throws IOException, IOException, ParseException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("tmFc","UTF-8") + "=" + URLEncoder.encode(String.valueOf(tmFc), "UTF-8")); /*-일 2회(06:00,18:00)회 생성 되며 발표시각을 입력- YYYYMMDD0600(1800) 최근 24시간 자료만 제공*/
    ...
    public ResponseEntity<?> longWeatherInfoData(@RequestParam String regId, @RequestParam int tmFc) throws IOException, IOException, ParseException {
